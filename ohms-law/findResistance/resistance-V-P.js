...
// output to console
console.log(
`a '${V} volt' source delivering '${P} watts' of power must have:
- a current draw of '${getCurrent(P, V)} amps' 
- an overall resistance of '${getResistance(V)} ohms'
